...
namespace Settworks.Hexagons
{
    ...
    public struct HexCoord : IComparer<HexCoord>, IComparable
    {
        ...
        private static readonly Vector2 HQ_XY = new Vector2(SQRT3, 0);

        private static readonly Vector2 HR_XY = new Vector2(SQRT3 / 2, 1.5f);
        private static readonly Vector2 HX_QR = new Vector2(SQRT3 / 3, 0);
        private static readonly Vector2 HY_QR = new Vector2(-1 / 3f, 2 / 3f);

        private static readonly Vector2 VQ_XY = new Vector2(1.5f, SQRT3 / 2);
        private static readonly Vector2 VR_XY = new Vector2(0, SQRT3);
        private static readonly Vector2 VX_QR = new Vector2(2 / 3f, -1 / 3f);
        private static readonly Vector2 VY_QR = new Vector2(0, SQRT3 / 3);
    }
}