...
public class HexFacing: MonoBehaviour {
	...
	public int halfSextant {	// Equals facing * 2.
		get { return _12th; }
	}
	...
	void OnChangedFacing() {
		Update12th();
		ApplyFacing(true);
	}

	void OnChangedRotationMode() {
		_mode = rotationMode;
		OnChangedAngle();
	}
	...
	void ApplyFacing(bool active = false) {
	...
	void SetLocalZ(float angle, bool radians = false) {
