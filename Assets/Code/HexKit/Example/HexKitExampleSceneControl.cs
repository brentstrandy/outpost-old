...
public class HexKitExampleSceneControl : MonoBehaviour
{
    ...
    private bool IsBlocked(HexCoord hex)
    {
        return blockers.Contains(hex) || !hex.IsWithinRectangle(bounds[0], bounds[1]);
    }

    private bool? IsTransparent(HexCoord hex)
    {
